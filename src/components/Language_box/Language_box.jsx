...
const Language_box = () => {
    ...
    const [content,setContent] = useState('Hello this is a content')
    ...
    useEffect(() => {
        langOpt.forEach(lang => console.log(lang['name']))
    })
  ...
  return (
    <div className={styles.container}>
        ...
        <Input_box content={content} setContent={setContent} isInput={isInput}/>
        {/* <Input_box content={content} setContent={setContent} isInput={!isInput}/> */}
    </div>
  )
}
